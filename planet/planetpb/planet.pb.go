...
type ListPlanetRequestFilter struct {
...
func (m *ListPlanetRequestFilter) Reset()         { *m = ListPlanetRequestFilter{} }
func (m *ListPlanetRequestFilter) String() string { return proto.CompactTextString(m) }
func (*ListPlanetRequestFilter) ProtoMessage()    {}
func (*ListPlanetRequestFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_4e7ae48ba9b9a6fb, []int{2}
}

func (m *ListPlanetRequestFilter) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ListPlanetRequestFilter.Unmarshal(m, b)
}
func (m *ListPlanetRequestFilter) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ListPlanetRequestFilter.Marshal(b, m, deterministic)
}
func (m *ListPlanetRequestFilter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListPlanetRequestFilter.Merge(m, src)
}
func (m *ListPlanetRequestFilter) XXX_Size() int {
	return xxx_messageInfo_ListPlanetRequestFilter.Size(m)
}
func (m *ListPlanetRequestFilter) XXX_DiscardUnknown() {
	xxx_messageInfo_ListPlanetRequestFilter.DiscardUnknown(m)
}

var xxx_messageInfo_ListPlanetRequestFilter proto.InternalMessageInfo

func (m *ListPlanetRequestFilter) GetColumn() string {
	if m != nil {
		return m.Column
	}
	return ""
...
func (m *ListPlanetRequestFilter) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
type BasicInformation struct {
	...
	StarSystem           string   `protobuf:"bytes,4,opt,name=star_system,json=starSystem,proto3" json:"star_system,omitempty"`
	MostAbundantResource string   `protobuf:"bytes,5,opt,name=most_abundant_resource,json=mostAbundantResource,proto3" json:"most_abundant_resource,omitempty"`
	SurfaceGravity       float64  `protobuf:"fixed64,6,opt,name=surface_gravity,json=surfaceGravity,proto3" json:"surface_gravity,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *BasicInformation) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
type ListPlanetRequest struct {
	...
	ListPlanetRequestFilter []*ListPlanetRequestFilter `protobuf:"bytes,2,rep,name=list_planet_request_filter,json=listPlanetRequestFilter,proto3" json:"list_planet_request_filter,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                   `json:"-"`
	XXX_unrecognized        []byte                     `json:"-"`
	XXX_sizecache           int32                      `json:"-"`
}
...
func (m *ListPlanetRequest) GetListPlanetRequestFilter() []*ListPlanetRequestFilter {
	if m != nil {
		return m.ListPlanetRequestFilter
	}
	return nil
}
...
type ListPlanetTypeRequest struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ListPlanetTypeRequest) Reset()         { *m = ListPlanetTypeRequest{} }
func (m *ListPlanetTypeRequest) String() string { return proto.CompactTextString(m) }
func (*ListPlanetTypeRequest) ProtoMessage()    {}
func (*ListPlanetTypeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_4e7ae48ba9b9a6fb, []int{8}
}

func (m *ListPlanetTypeRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ListPlanetTypeRequest.Unmarshal(m, b)
}
func (m *ListPlanetTypeRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ListPlanetTypeRequest.Marshal(b, m, deterministic)
}
func (m *ListPlanetTypeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListPlanetTypeRequest.Merge(m, src)
}
func (m *ListPlanetTypeRequest) XXX_Size() int {
	return xxx_messageInfo_ListPlanetTypeRequest.Size(m)
}
func (m *ListPlanetTypeRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ListPlanetTypeRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ListPlanetTypeRequest proto.InternalMessageInfo

type ListPlanetTypeResponse struct {
	PlanetType           []string `protobuf:"bytes,1,rep,name=planet_type,json=planetType,proto3" json:"planet_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ListPlanetTypeResponse) Reset()         { *m = ListPlanetTypeResponse{} }
func (m *ListPlanetTypeResponse) String() string { return proto.CompactTextString(m) }
func (*ListPlanetTypeResponse) ProtoMessage()    {}
func (*ListPlanetTypeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4e7ae48ba9b9a6fb, []int{9}
}

func (m *ListPlanetTypeResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ListPlanetTypeResponse.Unmarshal(m, b)
}
func (m *ListPlanetTypeResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ListPlanetTypeResponse.Marshal(b, m, deterministic)
}
func (m *ListPlanetTypeResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListPlanetTypeResponse.Merge(m, src)
}
func (m *ListPlanetTypeResponse) XXX_Size() int {
	return xxx_messageInfo_ListPlanetTypeResponse.Size(m)
}
func (m *ListPlanetTypeResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ListPlanetTypeResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ListPlanetTypeResponse proto.InternalMessageInfo

func (m *ListPlanetTypeResponse) GetPlanetType() []string {
	if m != nil {
		return m.PlanetType
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ListPlanetRequestFilter)(nil), "planet.ListPlanetRequestFilter")
	...
	proto.RegisterType((*ListPlanetTypeRequest)(nil), "planet.ListPlanetTypeRequest")
	proto.RegisterType((*ListPlanetTypeResponse)(nil), "planet.ListPlanetTypeResponse")
}
...
var fileDescriptor_4e7ae48ba9b9a6fb = []byte{
	...
	,
}
...
type PlanetServiceClient interface {
	...
	ListPlanetType(ctx context.Context, in *ListPlanetTypeRequest, opts ...grpc.CallOption) (*ListPlanetTypeResponse, error)
}
...
func (c *planetServiceClient) ListPlanetType(ctx context.Context, in *ListPlanetTypeRequest, opts ...grpc.CallOption) (*ListPlanetTypeResponse, error) {
	out := new(ListPlanetTypeResponse)
	err := c.cc.Invoke(ctx, "/planet.PlanetService/ListPlanetType", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PlanetServiceServer interface {
	...
	ListPlanetType(context.Context, *ListPlanetTypeRequest) (*ListPlanetTypeResponse, error)
}
...
func (*UnimplementedPlanetServiceServer) ListPlanetType(ctx context.Context, req *ListPlanetTypeRequest) (*ListPlanetTypeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListPlanetType not implemented")
}
...
func _PlanetService_ListPlanetType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListPlanetTypeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlanetServiceServer).ListPlanetType(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/planet.PlanetService/ListPlanetType",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlanetServiceServer).ListPlanetType(ctx, req.(*ListPlanetTypeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PlanetService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListPlanetType",
			Handler:    _PlanetService_ListPlanetType_Handler,
		},
	},
